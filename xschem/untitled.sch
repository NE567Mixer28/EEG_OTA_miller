...
C {devices/isource.sym} -390 -330 0 0 {name=I0 value=1u}
...
C {devices/launcher.sym} -1110 -240 0 0 {name=h1
descr="Annotate OP" 
...
C {devices/capa.sym} -160 -200 0 0 {name=C1
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {devices/isource.sym} -50 -330 0 0 {name=I1 value=1u}
